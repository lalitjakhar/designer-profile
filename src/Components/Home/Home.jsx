                                    ...
                                    <CardActionArea sx={{ justifyContent: 'center' }}>
                                        ...
                                        <Stack sx={{ justifyContent: 'center', alignItems: 'center' }}>
                                            <CardContent>
                                                ...
                                                <Typography gutterBottom variant="h5" component="div" sx={{ color: '#28402e', display: 'flex', justifyContent: 'center' }}>
                                                    UX/UI Designer
                                                </Typography>
                                                <Rating
                                                ...
                                                />
                                                <Typography variant="body1" color="text.secondary" sx={{ fontSize: '19px', letterSpacing: '1px' }}>
